...
#import "CStringPickerView.h"

@interface CStringPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic, copy) CStringResultBlock resultBlock;
// 单列选中的项
...
@implementation CStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
                  ...
                  defaultSelValue:(id)defaultSelValue
                     isAutoSelect:(BOOL)isAutoSelect
                      resultBlock:(CStringResultBlock)resultBlock {
    if (dataSource == nil || dataSource.count == 0) {
        return;
    }
    CStringPickerView *strPickerView = [[CStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
